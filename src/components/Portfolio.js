  ...
  render () {
    return (
      <div className='Portfolio'>
        <div className='Container pt-5 mt-4 pl-4'>
          <div className='row mw-100 mr-0'>
                  ...
                  <div className='card-container'>
                    <div className='card p-3 text-white bg-dark mb-3' style={{ width: '5 rem' }}><img className='card-img-top' src={CHUGG} alt='CHUGGED front page' />
                      <div className='card-body'>
                        ...
                        <p className='card-text'>For my Web Dev I final project, we created a website that facilitated user recipe submissions and accounts.</p><a className='btn btn-primary d-flex justify-content-center' href='https://github.com/tmitche2/cs546' target='_blank' rel='noopener noreferrer'>Repo</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className='col-md-4'>
              <div className='jumbotron'>
                <h4 className='display-4 pb-3'>Request my resume</h4>
                <p>Please fill out this short form and I'll send my resume out to you (not-yet functional) </p>
                <Form />
                <button onClick={this.handleNotReady} type='button' className='btn btn-primary'> Submit </button>
              </div>
            </div>
          </div>
        </div>
